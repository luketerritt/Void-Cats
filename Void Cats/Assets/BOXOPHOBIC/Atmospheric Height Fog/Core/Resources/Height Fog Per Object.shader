	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g839 = AHF_FogDistanceStart;
				half FogDistanceMask12_g771 = pow( abs( saturate( ( ( distance( WorldPosition2_g771 , _WorldSpaceCameraPos ) - temp_output_7_0_g839 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g839 ) ) ) ) , AHF_FogDistanceFalloff );
				...
				float3 lerpResult306_g771 = lerp( worldSpaceLightDir , AHF_DirectionalCustomDir , AHF_DirectionalCustom);
				float dotResult145_g771 = dot( normalizeResult318_g771 , lerpResult306_g771 );
				half DirectionalMask30_g771 = pow( abs( ( (dotResult145_g771*0.5 + 0.5) * AHF_DirectionalIntensity * AHF_DirectionalModeBlend ) ) , AHF_DirectionalFalloff );
				...
				float3 staticSwitch45_g771 = lerpResult258_g771;
				#elif defined(AHF_DIRECTIONALMODE_ON)
				float3 staticSwitch45_g771 = lerpResult40_g771;
				#else
				float3 staticSwitch45_g771 = lerpResult258_g771;
				#endif
				float3 temp_output_2_0_g837 = staticSwitch45_g771;
				float3 gammaToLinear3_g837 = GammaToLinearSpace( temp_output_2_0_g837 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g837 = temp_output_2_0_g837;
				#else
				float3 staticSwitch1_g837 = gammaToLinear3_g837;
				#endif
				float3 temp_output_256_0_g771 = staticSwitch1_g837;
				half3 AHF_FogAxisOption181_g771 = AHF_FogAxisOption;
				float3 break159_g771 = ( WorldPosition2_g771 * AHF_FogAxisOption181_g771 );
				float temp_output_7_0_g836 = AHF_FogHeightEnd;
				half FogHeightMask16_g771 = pow( abs( saturate( ( ( ( break159_g771.x + break159_g771.y + break159_g771.z ) - temp_output_7_0_g836 ) / ( AHF_FogHeightStart - temp_output_7_0_g836 ) ) ) ) , AHF_FogHeightFalloff );
				float temp_output_29_0_g771 = ( FogDistanceMask12_g771 * FogHeightMask16_g771 );
				...
				half NoiseDistanceMask7_g771 = saturate( ( ( distance( WorldPosition2_g771 , _WorldSpaceCameraPos ) - temp_output_7_0_g838 ) / ( 0.0 - temp_output_7_0_g838 ) ) );
				...
				float staticSwitch42_g771 = temp_output_29_0_g771;
				#elif defined(AHF_NOISEMODE_PROCEDURAL3D)
				float staticSwitch42_g771 = ( temp_output_29_0_g771 * NoiseSimplex3D24_g771 );
				#else
				float staticSwitch42_g771 = temp_output_29_0_g771;
				#endif
...
/*ASEBEGIN
Version=18103
1927;7;1906;1014;4132.027;3675.353;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;935;-2816,-4512;Inherit;False;Is Pipeline;1;;840;2b33d0c660fbdb24c98bea96428031b0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=837D570184498EEC0BD4E1A1E1EF8559C44E7C6A