	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float temp_output_7_0_g879 = AHF_FogDistanceStart;
				half FogDistanceMask12_g874 = pow( abs( saturate( ( ( distance( WorldPosition2_g874 , _WorldSpaceCameraPos ) - temp_output_7_0_g879 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g879 ) ) ) ) , AHF_FogDistanceFalloff );
				...
				float3 lerpResult306_g874 = lerp( worldSpaceLightDir , AHF_DirectionalCustomDir , AHF_DirectionalCustom);
				float dotResult145_g874 = dot( normalizeResult318_g874 , lerpResult306_g874 );
				half DirectionalMask30_g874 = pow( abs( ( (dotResult145_g874*0.5 + 0.5) * AHF_DirectionalIntensity * AHF_DirectionalModeBlend ) ) , AHF_DirectionalFalloff );
				...
				float3 staticSwitch45_g874 = lerpResult258_g874;
				#elif defined(AHF_DIRECTIONALMODE_ON)
				float3 staticSwitch45_g874 = lerpResult40_g874;
				#else
				float3 staticSwitch45_g874 = lerpResult258_g874;
				#endif
				float3 temp_output_2_0_g877 = staticSwitch45_g874;
				float3 gammaToLinear3_g877 = GammaToLinearSpace( temp_output_2_0_g877 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g877 = temp_output_2_0_g877;
				#else
				float3 staticSwitch1_g877 = gammaToLinear3_g877;
				#endif
				float3 temp_output_256_0_g874 = staticSwitch1_g877;
				...
				float temp_output_7_0_g876 = AHF_FogHeightEnd;
				half FogHeightMask16_g874 = pow( abs( saturate( ( ( ( break159_g874.x + break159_g874.y + break159_g874.z ) - temp_output_7_0_g876 ) / ( AHF_FogHeightStart - temp_output_7_0_g876 ) ) ) ) , AHF_FogHeightFalloff );
				float temp_output_29_0_g874 = ( FogDistanceMask12_g874 * FogHeightMask16_g874 );
				float simplePerlin3D193_g874 = snoise( ( ( WorldPosition2_g874 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * _Time.y ) ) );
				float temp_output_7_0_g878 = AHF_NoiseDistanceEnd;
				half NoiseDistanceMask7_g874 = saturate( ( ( distance( WorldPosition2_g874 , _WorldSpaceCameraPos ) - temp_output_7_0_g878 ) / ( 0.0 - temp_output_7_0_g878 ) ) );
				...
				float staticSwitch42_g874 = temp_output_29_0_g874;
				#elif defined(AHF_NOISEMODE_PROCEDURAL3D)
				float staticSwitch42_g874 = ( temp_output_29_0_g874 * NoiseSimplex3D24_g874 );
				#else
				float staticSwitch42_g874 = temp_output_29_0_g874;
				#endif
...
/*ASEBEGIN
Version=18103
1927;7;1906;1014;359.1003;561.1945;1;True;False
...
ASEEND*/
//CHKSM=9160F57E119EBE6400385E071AD7414EC1E7025A