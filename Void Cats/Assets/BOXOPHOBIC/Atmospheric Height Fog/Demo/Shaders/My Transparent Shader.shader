...
Shader "Custom/My Transparent Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_7_0_g841 = AHF_FogDistanceStart;
			half FogDistanceMask12_g836 = pow( abs( saturate( ( ( distance( WorldPosition2_g836 , _WorldSpaceCameraPos ) - temp_output_7_0_g841 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g841 ) ) ) ) , AHF_FogDistanceFalloff );
			...
			#endif //aseld
			float3 lerpResult306_g836 = lerp( ase_worldlightDir , AHF_DirectionalCustomDir , AHF_DirectionalCustom);
			float dotResult145_g836 = dot( normalizeResult318_g836 , lerpResult306_g836 );
			half DirectionalMask30_g836 = pow( abs( ( (dotResult145_g836*0.5 + 0.5) * AHF_DirectionalIntensity * AHF_DirectionalModeBlend ) ) , AHF_DirectionalFalloff );
			float3 lerpResult40_g836 = lerp( lerpResult258_g836 , (AHF_DirectionalColor).rgb , DirectionalMask30_g836);
				...
				float3 staticSwitch45_g836 = lerpResult258_g836;
			#elif defined(AHF_DIRECTIONALMODE_ON)
				float3 staticSwitch45_g836 = lerpResult40_g836;
			#else
				float3 staticSwitch45_g836 = lerpResult258_g836;
			#endif
			float3 temp_output_2_0_g839 = staticSwitch45_g836;
			float3 gammaToLinear3_g839 = GammaToLinearSpace( temp_output_2_0_g839 );
			#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g839 = temp_output_2_0_g839;
			#else
				float3 staticSwitch1_g839 = gammaToLinear3_g839;
			#endif
			float3 temp_output_256_0_g836 = staticSwitch1_g839;
			...
			float temp_output_7_0_g838 = AHF_FogHeightEnd;
			half FogHeightMask16_g836 = pow( abs( saturate( ( ( ( break159_g836.x + break159_g836.y + break159_g836.z ) - temp_output_7_0_g838 ) / ( AHF_FogHeightStart - temp_output_7_0_g838 ) ) ) ) , AHF_FogHeightFalloff );
			float temp_output_29_0_g836 = ( FogDistanceMask12_g836 * FogHeightMask16_g836 );
			float simplePerlin3D193_g836 = snoise( ( ( WorldPosition2_g836 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * _Time.y ) ) );
			float temp_output_7_0_g840 = AHF_NoiseDistanceEnd;
			half NoiseDistanceMask7_g836 = saturate( ( ( distance( WorldPosition2_g836 , _WorldSpaceCameraPos ) - temp_output_7_0_g840 ) / ( 0.0 - temp_output_7_0_g840 ) ) );
			...
			half NoiseSimplex3D24_g836 = lerpResult198_g836;
				...
				float staticSwitch42_g836 = temp_output_29_0_g836;
			#elif defined(AHF_NOISEMODE_PROCEDURAL3D)
				float staticSwitch42_g836 = ( temp_output_29_0_g836 * NoiseSimplex3D24_g836 );
			#else
				float staticSwitch42_g836 = temp_output_29_0_g836;
			#endif
...
/*ASEBEGIN
Version=18103
1927;7;1906;1014;-509.9722;-598.3928;1;True;False
...
ASEEND*/
//CHKSM=4894C70179D4BE7BFC50057CD25576A555DE225A